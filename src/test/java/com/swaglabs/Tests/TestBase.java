...
public class TestBase {
    ...
    public String username = "SauceFrank";

    public String accesskey = "70d8fea3-9242-4aea-ba5a-4f51755e7eeb";

// public String accesskey = System.getenv("70d8fea3-9242-4aea-ba5a-4f51755e7eeb");
    /**
    ...
    * username and access key populated by the {@link #authentication}
    ...
    protected void createDriver(String browser, String version, String os, String methodName)
       ...
       capabilities.setCapability("build", "Frank Sauce Demo");
